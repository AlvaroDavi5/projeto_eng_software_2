...
Conforme a Figura~\ref{figura-cius}, cada subpacote da CIU pode ser representado por um fluxo. A seguir, são representados os principais fluxos da CIU:

\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth,height=0.4\textheight]{figuras/ciu_cliente.png}
