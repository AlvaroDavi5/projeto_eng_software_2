...
\vitor{Não incluir as classes no modelo da arquitetura. Apenas os pacotes.}
\alvaro{Melhorar dependências da CIU; Reorganizar partições/subsistemas (retirar ou documentar); Separar CGD e CDP.}
...
\end{itemize}
\vitor{Se há divisão em subsistemas, então foi adotado o estilo arquitetônico de partições.}
...
\end{itemize}
\vitor{CDP não é um componente dentro da CLN? CLN não está se comunicando diretamente com CDP!}
