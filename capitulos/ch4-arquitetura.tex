...
\alvaro{Falta terminar o relacionamento das entidades, melhorar a organização dos pacotes e especificar qual camada/partição cada pacote representa. Alterar arquivo do diagrama: 'Pet Shop.drawio' e substituir a Figura~\ref{figura-arquitetura}.}
\vitor{Caso use alguma arquitetura clássica, incluir referência bibliográfica com BibTeX (ex.:Camada de Serviço~\cite{fowler:book02}). Como exemplo, vide documentos de projeto do Marvin e da Locadora de Carros do prof. Ricardo Falbo.}
