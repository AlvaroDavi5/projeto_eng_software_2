...
\begin{center}
	...
	\begin{tabular}{|c|p{45mm}|c|p{60mm}|} \hline
		...
		4.1             & Pedro Quedevez       & 15/12/2025    & Revisão do Diagrama do Domínio (Cap. \ref{sec-componentes-cdp}).                                                             \\\hline
		4.2             & Mateus Loss          & 16/12/2025    & Definição da Camada de Interface com o Usuário (Cap. \ref{sec-ciu}).                                                         \\\hline
	\end{tabular}
\end{center}
\newpage
