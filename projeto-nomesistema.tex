...
\begin{center}
	...
	\begin{tabular}{|c|p{45mm}|c|p{60mm}|} \hline
		...
		1.1             & Gabriel Lima         & 23/10/2025    & Especificação dos requisitos não funcionais (Cap. \ref{sec-rnfs}) e das camadas da arquitetura (Cap. \ref{sec-arquitetura}). \\\hline
		1.2             & Álvaro Alves         & 24/10/2025    & Especificação da plataforma e tecnologias (Cap. \ref{sec-plataforma}).                                                       \\\hline
		1.3             & Álvaro Alves         & 26/10/2025    & Construção inicial da arquitetura (Cap. \ref{sec-arquitetura}).                                                              \\\hline
		1.4             & Álvaro Alves         & 27/10/2025    & Finalização da arquitetura (Cap. \ref{sec-arquitetura}).                                                                     \\\hline
	\end{tabular}
\end{center}
\newpage
